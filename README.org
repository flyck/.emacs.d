* If you are new here
  ...
  you're just starting out with emacs, consider using [[https://github.com/doomemacs/doomemacs][doom emacs]] or [[https://prelude.emacsredux.com/][emacs prelude]] as a base.

  While customising my own config over the years, I also found some nice tutorials on emacs in
  general which I'd like to point out:
