...
** Org-mode
   #+BEGIN_SRC emacs-lisp
     (use-package org
       ...
       ;; do my org-ref settings need to be in here?
...
*** Org-gcal
    #+BEGIN_SRC emacs-lisp
    ;; dont commit this to public!
    (use-package org-gcal
        :if (equal "home" (getenv "SYSENV"))
        :config
        (require 'org-gcal)
        (setq org-gcal-client-id "598031872633-tv73udova1emgokmceet2bktcu17e0ab.apps.googleusercontent.com"
              org-gcal-client-secret "64bWsqdFylIJ5BDqQuBQavmf "
              org-gcal-file-alist '(("felix.brilej@googlemail.com" .  "C:/Users/Scat666/Dropbox/org/gtd/gcal.org")
                                    ))
        )
