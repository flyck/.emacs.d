      ...
      #+BEGIN_SRC emacs-lisp
       (if (equal "home" (getenv "SYSENV"))
           (progn (setq org-agenda-files (list
                                          (concat "/root/Dropbox/org/gtd/tasks.org")
                                          (concat "/root/Dropbox/org/gtd/tasks.org_archive")
                                          (concat "/root/Dropbox/org/hobby/dactyl-keyboard/dactyl-keyboard-guide/index.org")
                                          (concat "/root/Dropbox/org/uni/bachelor_thesis/bachelor_thesis.org")
                                          (concat "/root/Dropbox/org/gtd/tasks_2015")
                                          (concat "/root/Dropbox/org/gtd/tasks_2016")
                                          (concat "/root/Dropbox/org/gtd/tasks_2017")
                                          ))
              ;; org-capture setup
              (setq org-default-notes-file (concat "/root/Dropbox/org/gtd/tasks.org"))
