...
(add-to-list 'exec-path "/Users/felix.brilej/.nvm/versions/node/v14.19.1/bin")
   #+end_src
...
(use-package tide
  ...
  (global-set-key (kbd "C-x lr") #'tide-references)
  (global-set-key (kbd "C-x rs") #'tide-rename-symbol)
  (global-set-key (kbd "C-x rf") #'tide-rename-file)
  (global-set-key (kbd "C-x re") #'next-error)
(setq tide-node-executable "/Users/felix.brilej/.nvm/versions/node/v14.19.1/bin/node")
  :after (typescript-mode company flycheck)
