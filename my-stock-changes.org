...
**** Font settings for my laptop                              :sysenv:
     Font installation hints for Linux (Ubuntu)
     #+BEGIN_SRC emacs-lisp
       ;; Fonts
     ...
     #+BEGIN_SRC emacs-lisp
       (if (equal "laptop" (getenv "SYSENV"))
           (set-frame-font "-ADBO-Source Code Pro-semibold-normal-normal-*-20-*-*-*-m-0-iso10646-1" nil t)
         )
       ;; not sure what this does, but it can be used for some kind of resizing
       ;; (set-face-attribute 'default nil :height 100)
     #+END_SRC
**** Font settings for home                                   :sysenv:
     #+BEGIN_SRC emacs-lisp
