...
uv tool install ruff
   ...
   #+begin_src emacs-lisp
;; Python LSP using pyright + ruff
;; Pyright: type checking, navigation, renaming (uv tool install pyright)
...
(use-package lsp-pyright
  ...
  (setq lsp-pyright-type-checking-mode "off")  ;; "off", "basic", or "strict"
