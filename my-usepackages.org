...
;; Python LSP - install pyright: npm install -g pyright
(use-package lsp-pyright
  ...
  :hook (python-mode . (lambda ()
                         (require 'lsp-pyright)
                         ;; Enable only pyright for this buffer
...
** Python programming
   ...
   *PREREQUISITES*: Install Pyright before using this config:
   #+begin_src sh
npm install -g pyright
   ...
   Alternative language server (not recommended, pyright is better):
