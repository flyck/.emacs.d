...
**** Support for org-super-agenda
     Org-super-agenda can be downloaded from here: https://github.com/alphapapa/org-super-agenda

     According to the isntallation manual it needs the s package.
     #+BEGIN_SRC emacs-lisp
     (load "~/.emacs.d/elpa/org-super-agenda.el")
     (use-package s
       :ensure t
     )
     #+END_SRC
