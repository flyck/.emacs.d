...
** Eziam theme
   ...
   #+BEGIN_SRC emacs-lisp
     ;; (add-to-list 'load-path "~/.emacs.d/elpa/eziam-theme-emacs")
     ;; (add-to-list 'custom-theme-load-path "~/.emacs.d/elpa/eziam-theme-emacs")
   ...
   #+BEGIN_SRC sh :dir ~/.emacs.d/elpa/ :results silent
...
** Prassee theme
   ...
   :RESULTS:
   total 36
   -rwxrwxr-x+ 1 FBrilej Domain Users 11357 Feb 17 12:18 LICENSE
   -rwxrwxr-x+ 1 FBrilej Domain Users  1576 Feb 17 12:18 README.md
   -rwxrwxr-x+ 1 FBrilej Domain Users 18403 Feb 20 11:56 prassee-theme.el
   :END:
