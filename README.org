* If you are new here
  This config is highly customized, and is probably not a good starting point for a beginner. If
  you're just starting out with emacs, consider using [[https://github.com/doomemacs/doomemacs][doom emacs]] or [[https://prelude.emacsredux.com/][emacs prelude]] as a base. While
  customising my own config over the years, I also found some nice tutorials on emacs in general
  ...
  For the experienced user, feel free to dig through. I hope you will find some gems!
